...
namespace Util
{
    class SvnWrapper
    {
        ...
        // 戻り値 | なし
        // - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = -
        public static void Svn_Merge(string rev_Start, string rev_End, string path_Src, string path_WC)
        {
            // path_Src における
        ...
        // 戻り値 | なし
        // - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = -
        public static void Svn_Merge_Ow(string path_Src, string path_WC, string rev_Src="HEAD")
        {
        ...
        // 戻り値 | なし
        // - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = -
        public static void Svn_Copy(string path_Src, string path_Dst)
        {
            // path_Src における
            // リビジョン rev_Start から rev_End までの変更を
            // path_WC に適用する
